Public Class frmRptJournalReportVer00
    ...
    Private Sub prvPreview()
        ...
        Try
            Dim crReport As New rptJournalReportVer00
            crReport.DataSource = BL.Reports.JournalReport(dtpDateFrom.Value.Date, dtpDateTo.Value.Date, intCompanyID, intProgramID)
            With crReport
...
#Region "Form Handle"
    ...
    Private Sub frmRptJournalReport_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form ini?") Then Me.Close()
        End If
    End Sub

    Private Sub frmRptJournalReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
