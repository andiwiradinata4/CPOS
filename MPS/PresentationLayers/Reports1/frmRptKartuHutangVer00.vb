    ...
    Private Function prvCollectDataVer00(ByVal drPick() As DataRow) As DataTable
        ...
        Try
            ...
            For Each dr As DataRow In drPick
                '# Get Last Balance
                Dim decFirstBalance As Decimal = BL.Reports.KartuHutangLastBalance(dtpDateFrom.Value.Date, MPSLib.UI.usUserApp.ProgramID, MPSLib.UI.usUserApp.CompanyID, dr.Item("ID"))

                '# Calculate Table Return
                dtCurrent = BL.Reports.KartuHutangVer00Report(dtpDateFrom.Value.Date, dtpDateTo.Value.Date, MPSLib.UI.usUserApp.ProgramID, MPSLib.UI.usUserApp.CompanyID, dr.Item("ID"))
                With dtCurrent
