Public Class frmRptSalesReportVer00
...
#End Region
    ...
    Private Sub prvFillCombo()
        Try
            ...
            UI.usForm.FillComboBox(cboRemarks, dtData, "Remarks", "Remarks")
            cboRemarks.SelectedValue = "SEMUA"
        Catch ex As Exception
            UI.usForm.frmMessageBox(ex.Message)
        End Try
    End Sub
    ...
    Private Sub prvPreview()
        ...
        pgMain.Value = 30
        Try
            Dim crReport As New rptSalesReportVer00
            With crReport
                .DataSource = BL.Reports.SalesReport(intCompanyID, MPSLib.UI.usUserApp.ProgramID, dtpDateFrom.Value.Date, dtpDateTo.Value.Date, prvSelectedCheckList(chkListCustomer), prvSelectedCheckList(chkListSupplier), cboRemarks.SelectedValue)
...
#Region "Form Handle"
    ...
    Private Sub frmRptSalesReportVer00_Load(sender As Object, e As EventArgs) Handles MyBase.Load
