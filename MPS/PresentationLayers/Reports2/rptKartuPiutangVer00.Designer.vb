...
Partial Public Class rptKartuPiutangVer00
    ...
    Private Sub InitializeComponent()
        ...
        'ObjectDataSource1
        '
        Me.ObjectDataSource1.DataSource = GetType(MPSLib.VO.rptKartuPiutangReport)
        Me.ObjectDataSource1.Name = "ObjectDataSource1"
        '
        'rptKartuPiutangVer00
        '
