Public Class frmMstBusinessPartnerAssignItem

#Region "Property"

    Private frmParent As frmMstBusinessPartnerAssign
...
#End Region
    ...
    Private Sub prvSave()
        ...
        If pubIsNew Then
            Dim drFind() As DataRow = pubDtItem.Select("ProgramID=" & intProgramID & " AND CompanyID=" & intCompanyID)
            If drFind.Count > 0 Then
                UI.usForm.frmMessageBox("Program " & txtProgramName.Text.Trim & " dengan perusahaan " & txtCompanyName.Text.Trim & " telah ada sebelumnya")
                txtProgramName.Focus()
                Exit Sub
            End If
        ...
        Else
            Dim drFind() As DataRow = pubDtItem.Select("ProgramID=" & intProgramID & " AND CompanyID=" & intCompanyID & " AND ID<>'" & strID & "'")
            If drFind.Count > 0 Then
                UI.usForm.frmMessageBox("Program " & txtProgramName.Text.Trim & " dengan perusahaan " & txtCompanyName.Text.Trim & " telah ada sebelumnya")
                txtProgramName.Focus()
                Exit Sub
...
#Region "Form Handle"
    ...
    Private Sub frmMstBusinessPartnerAssignItem_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmMstBusinessPartnerAssignItem_Load(sender As Object, e As EventArgs) Handles MyBase.Load
