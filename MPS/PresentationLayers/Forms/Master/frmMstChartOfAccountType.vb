Public Class frmMstChartOfAccountType
    ...
    Private Sub prvQuery()
        Try
            grdMain.DataSource = BL.ChartOfAccountType.ListData()
    ...
    Private Sub prvGet()
        ...
        If grdView.GetRowCellValue(intPos, "IDStatus") = VO.Status.Values.InActive Then
            UI.usForm.frmMessageBox("Tidak dapat pilih tipe akun " & grdView.GetRowCellValue(intPos, "Name") & ". Dikarenakan tipe akun tersebut sudah tidak aktif")
            Exit Sub
        Else
    ...
    Private Sub prvNew()
        Dim frmDetail As New frmMstChartOfAccountTypeDet
        With frmDetail
            .pubIsNew = True
    ...
    Private Sub prvDelete()
        ...
        Try
            BL.ChartOfAccountType.DeleteData(grdView.GetRowCellValue(intPos, "ID"))
...
#Region "Form Handle"
    ...
    Private Sub frmMstChartOfAccountType_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form ini?") Then Me.Close()
        End If
    End Sub

    Private Sub frmMstChartOfAccountType_Load(sender As Object, e As EventArgs) Handles MyBase.Load
