Public Class frmTraDownPaymentVer2Det

#Region "Property"

    Private frmParent As frmTraDownPaymentVer2
...
#End Region
    ...
    Private Sub prvSave()
        ...
        clsData.DPType = VO.DownPayment.Type.SalesService
...
#Region "Form Handle"
    ...
    Private Sub frmTraDownPaymentVer2Det_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmTraDownPaymentVer2Det_Load(sender As Object, e As EventArgs) Handles MyBase.Load
