...
#End Region
    ...
    Private Sub prvSetGrid()
        ...
        UI.usForm.SetGrid(grdView, "BPID2", "BPID2", 100, UI.usDefGrid.gIntNum, False)
        UI.usForm.SetGrid(grdView, "BPName2", "Pemasok", 100, UI.usDefGrid.gString)
    ...
    Private Sub prvFillCombo()
        Try
            Dim dtData As DataTable = BL.StatusModules.ListDataByModulesID(VO.Modules.Values.TransactionSalesDownPayment)
            Dim dr As DataRow
            dr = dtData.NewRow
            With dr
                .BeginEdit()
    ...
    Private Sub prvQuery()
        ...
        pgMain.Value = 30
        Try
            grdMain.DataSource = BL.DownPayment.ListData(intCompanyID, MPSLib.UI.usUserApp.ProgramID, dtpDateFrom.Value.Date, dtpDateTo.Value.Date, cboStatus.SelectedValue, VO.DownPayment.Type.Sales)
            prvSumGrid()
    ...
    Private Function prvGetData() As VO.DownPayment
        ...
        clsReturn.BPID2 = grdView.GetRowCellValue(intPos, "BPID2")
        clsReturn.BPName2 = grdView.GetRowCellValue(intPos, "BPName2")
