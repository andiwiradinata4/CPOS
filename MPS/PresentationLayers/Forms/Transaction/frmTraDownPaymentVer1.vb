...
Public Class frmTraDownPaymentVer1
...
#End Region
    ...
    Private Sub prvQuery()
        ...
        pgMain.Value = 30
        Try
            grdMain.DataSource = BL.DownPayment.ListData(intCompanyID, MPSLib.UI.usUserApp.ProgramID, dtpDateFrom.Value.Date, dtpDateTo.Value.Date, cboStatus.SelectedValue, VO.DownPayment.Type.Purchase)
            prvSumGrid()
    ...
    Private Sub prvNew()
        Dim frmDetail As New frmTraDownPaymentVer1Det
        With frmDetail
            .pubIsNew = True
            .pubCS = prvGetCS()
...
#Region "Form Handle"
    ...
    Private Sub frmTraDownPaymentVer1_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraDownPaymentVer1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
