Namespace DL
    Public Class PaymentReferences
        Public Shared Function ListData() As DataTable
            ...
            With sqlcmdExecute
                .CommandText = _
                   ...
                   "FROM mstPaymentReferences A " & vbNewLine & _
        ...
        Public Shared Function ListDataAll() As DataTable
            ...
            With sqlcmdExecute
                .CommandText = _
                    ...
                    "      ,[LogDate]	" & vbNewLine & _
                    "      ,[LogInc]	" & vbNewLine & _
                    "  FROM [dbo].[mstPaymentReferences]	" & vbNewLine

            End With
            Return SQL.QueryDataTable(sqlcmdExecute)
        End Function

        Public Shared Sub SaveData(ByVal bolNew As Boolean, ByVal clsData As VO.PaymentReferences)
            Dim sqlcmdExecute As New SqlCommand
            With sqlcmdExecute
                If bolNew Then
                    .CommandText = _
                       "INSERT INTO mstPaymentReferences " & vbNewLine & _
                       "    (ID, Name, IDStatus, CreatedBy, CreatedDate, LogBy, LogDate)   " & vbNewLine & _
                       "VALUES " & vbNewLine & _
                       "    (@ID, @Name, @IDStatus, @LogBy, GETDATE(), @LogBy, GETDATE())  " & vbNewLine
                Else
                    .CommandText = _
                    "UPDATE mstPaymentReferences SET " & vbNewLine & _
        ...
        Public Shared Sub SaveDataAll(ByVal clsData As VO.PaymentReferences)
            Dim sqlcmdExecute As New SqlCommand
            With sqlcmdExecute
                .CommandText = _
                   "INSERT INTO mstPaymentReferences " & vbNewLine & _
        ...
        Public Shared Function GetDetail(ByVal intID As Integer) As VO.PaymentReferences
            ...
            Dim voReturn As New VO.PaymentReferences
            Try
        ...
        Public Shared Sub DeleteData(ByVal intID As Integer)
            ...
            With sqlcmdExecute
                .CommandText = _
                    "UPDATE mstPaymentReferences " & vbNewLine & _
        ...
        Public Shared Sub DeleteDataAll()
            ...
            With sqlcmdExecute
                .CommandText = _
                    "DELETE mstPaymentReferences " & vbNewLine
            ...
            Try
                ...
                With sqlcmdExecute
                    ...
                    .CommandText = _
                        ...
                        "FROM mstPaymentReferences " & vbNewLine
            ...
            Try
                ...
                With sqlcmdExecute
                    ...
                    .CommandText = _
                        "SELECT TOP 1 " & vbNewLine & _
                        "   ID " & vbNewLine & _
                        "FROM mstPaymentReferences " & vbNewLine & _
                        "WHERE  " & vbNewLine & _
                        "   ID=@ID " & vbNewLine
