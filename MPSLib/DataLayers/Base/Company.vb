Namespace DL
    Public Class Company
        ...
        Public Shared Function ListDataAll() As DataTable
            ...
            With sqlcmdExecute
                .CommandText = _
                    ...
                    "      ,[Name]	" & vbNewLine & _
                    "      ,[Address]	" & vbNewLine & _
                    "      ,[PhoneNumber]	" & vbNewLine & _
                    "      ,[CompanyInitial]	" & vbNewLine & _
        ...
        Public Shared Sub SaveDataAll(ByVal clsData As VO.Company)
            Dim sqlcmdExecute As New SqlCommand
            With sqlcmdExecute
                .CommandText = _
                   "INSERT INTO mstCompany " & vbNewLine & _
                   "    (ID, Name, Address, PhoneNumber, CompanyInitial, IDStatus, CreatedBy,   " & vbNewLine & _
                   "     CreatedDate, LogBy, LogDate, LogInc)   " & vbNewLine & _
                   "VALUES " & vbNewLine & _
                   "    (@ID, @Name, @Address, @PhoneNumber, @CompanyInitial, @IDStatus, @CreatedBy,   " & vbNewLine & _
                   "     @CreatedDate, @LogBy, @LogDate, @LogInc)  " & vbNewLine
