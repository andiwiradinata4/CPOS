Namespace DL
    Public Class Status
        ...
        Public Shared Function ListData() As DataTable
            ...
            With sqlcmdExecute
                .CommandText = _
                   ...
                   "FROM mstStatus A " & vbNewLine

            End With
            Return SQL.QueryDataTable(sqlcmdExecute)
        End Function

        Public Shared Sub SaveData(ByVal bolNew As Boolean, ByVal clsData As VO.Status)
            Dim sqlcmdExecute As New SqlCommand
            With sqlcmdExecute
                If bolNew Then
                    .CommandText = _
                       "INSERT INTO mstStatus " & vbNewLine & _
                ...
                Else
                    .CommandText = _
                    "UPDATE mstStatus SET " & vbNewLine & _
        ...
        Public Shared Sub SaveDataAll(ByVal clsData As VO.Status)
            Dim sqlcmdExecute As New SqlCommand
            With sqlcmdExecute
                .CommandText = _
                   "INSERT INTO mstStatus " & vbNewLine & _
